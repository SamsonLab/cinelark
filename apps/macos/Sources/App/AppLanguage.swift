...
enum AppLanguage: String, CaseIterable, Identifiable {
    ...
    private static let errorLocalizationKeys: [String: String] = [
        ...
        "Complete the IINA Bridge installation and enable it, then try again.": "error.iina_plugin_install",
        "CineLark needs to install or update its IINA Bridge. Fully quit IINA, then play again so CineLark can finish safely.": "error.iina_plugin_setup_quit",
        "CineLark could not safely install the bundled IINA Bridge. Reinstall CineLark, then try again.": "error.iina_plugin_install_failed",
        "The CineLark IINA Bridge did not connect. In IINA, choose Plugins > CineLark Bridge > Reconnect CineLark Bridge, then retry.": "error.iina_plugin_unavailable",
        "IINA did not load the media in time. Reconnect the CineLark Bridge, then retry.": "error.iina_load_timeout",
